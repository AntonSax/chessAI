...
class AI(BaseAI):
    ...
    def time_limited_alpha_beta_depth_limited_minimax(self, Board, start_time, time_limit, alpha, beta, depth, maximizing_player):
        ...
        if maximizing_player == True:
            ...
            for child in child_node_list:
                new_list = self.time_limited_alpha_beta_depth_limited_minimax(child, start_time, time_limit, alpha, beta, depth-1, False)
        ...
        # Maximizing player == False, its the minimizing player's turn.
            ...
            best_value = 1000
            for child in child_node_list:
                new_list = self.time_limited_alpha_beta_depth_limited_minimax(child, start_time, time_limit, alpha, beta, depth-1, True)
                new_value = new_list[0]
    ...
    def time_limited_iterative_deepening_alpha_beta_depth_limited_minimax(self):
        ...
        for depth in range(1, depth_limit_int+1):
            ...
            best_move = self.time_limited_alpha_beta_depth_limited_minimax(self.Board, start_time, time_limit, starting_alpha, starting_beta, depth, True)
